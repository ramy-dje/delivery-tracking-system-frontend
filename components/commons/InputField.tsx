...
export default function InputField({ label, type = "text", placeholder, icon: Icon, value, onChange, error, step, required = false, disabled = false }: InputFieldProps) {
    return (
        <div>
            <label className="block text-sm font-medium text-slate-300 mb-2">{label} {required && <span className="text-red-500">*</span>}</label>
